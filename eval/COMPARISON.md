...
> Pi is a **15,000× larger** harness with more features. pu.sh is 310 lines of shell with zero dependencies beyond `sh` + `curl` — including a hand-rolled JSON parser in awk.
